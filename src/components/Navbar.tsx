...
export function Navbar() {
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-stone-950/45 px-6 py-4 text-white backdrop-blur-xl sm:px-10 lg:px-16">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="font-[var(--heading)] text-xl font-semibold leading-none tracking-[-0.03em] text-white">
              Florida Land
            </p>
